              ...
              .end((err, res) => {
                ...
                client
                  ...
                  .end((err, res) => {
                    ...
                    client
                      .delete(
                        `/api/roles/child/resources/${initialResource.name}`
                      )
                      .set('content-type', 'application/json')
                      .set('Authorization', `Bearer ${bearerToken}`)
                      .expect('content-type', 'application/json')
                      .end((err, res) => {
                        ...
                        client
                          ...
                          .end((err, res) => {
                            ...
                            should.not.exist(
                              result.resources[initialResource.name]
                            )
