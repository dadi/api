...
module.exports = () => {
  ...
  describe('success states (the client has "create" access to the "clients" resource)', () => {
    ...
    it('should create a client with a resources object', done => {
      const testClient = {
        clientId: 'apiClient',
        secret: 'someSecret',
        accessType: 'admin'
              ...
              .end((err, res) => {
                ...
                client
                  ...
                  .end((err, res) => {
                    ...
                    const {accessToken: userToken} = res.body
    ...
    it('should create a client with a roles array', done => {
      const testClient = {
        clientId: 'apiClient',
        secret: 'someSecret',
        accessType: 'admin'
              ...
              .end((err, res) => {
                ...
                client
                  ...
                  .end((err, res) => {
                    ...
                    res.body.results[0].accessType.should.eql('user')
                    res.body.results[0].resources.should.eql({})
                    res.body.results[0].roles.should.eql(newClient.roles)
